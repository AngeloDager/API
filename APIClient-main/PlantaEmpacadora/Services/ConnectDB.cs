...
namespace PlantaEmpacadora.Services
{
    public static class ConnectDB
    {
        ...
        public static SqlConnection Conectar(string Host, string Database, string Username, string Password)
        {
            SqlConnection Connexion;
            try
            {
                if (Username == null)
                    Connexion = new SqlConnection(StringConnectionWindowsAuthentication(Host, Database));
                else
                    Connexion = new SqlConnection(StringConnectionSqlServerAuthentication(Host, Database, Username, Password));
            }
            catch (Exception)
            {
                Connexion = null;
